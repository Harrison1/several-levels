  ...
  <div>
    <Header />
      <Container>
        <Row>
          <Col12>
            <h3 className="text-center intro-text">Hi, welcome to <span className="sl-font-color">several levels</span>. My name is Harrison McGuire and I am the founder and lead software developer. I'm dedidicated to making excellent, performant, modern websites.</h3>
          </Col12>
        </Row>
        <hr />
